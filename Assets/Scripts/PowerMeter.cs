...
public class PowerMeter : MonoBehaviour {
    ...
    private void HandlePlayerInput() {
        if(speed < DragDropObjects.WindPower / 1000000) 
        {
        ...
        PowerText.text = ("Wind Power: " + (DragDropObjects.WindPower / 1000000).ToString("0.00") + " MW");
        //if (Rotator.RPM >= temp)
        //{
        //    //float acceleration = 30f;
        //    speed += Rotator.RPM * Time.deltaTime;
        //}
        //if (Rotator.RPM <= temp)
        //{
